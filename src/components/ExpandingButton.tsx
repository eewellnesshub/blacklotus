                ...
                <div className="flex-1 flex flex-col justify-center space-y-3 w-full">
                  ...
                  <div className="space-y-4 sm:space-y-6 pt-4">
                    <div className="flex gap-3 sm:gap-4">
                      ...
                      <div>
                        <p className="text-sm sm:text-base text-white leading-[150%]">
                          Learn how Black Lotus can transform your business with tailored solutions and flexible pricing
                          options.
                        </p>
                      </div>
                    </div>
                    <div className="flex gap-3 sm:gap-4">
                      ...
                      <div>
                        <p className="text-sm sm:text-base text-white leading-[150%]">
                          Experience firsthand how Black Lotus Platform accelerates delivery &amp; drives results.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="pt-6 sm:pt-8 mt-6 sm:mt-8 border-t border-white/20">
                    <p className="text-lg sm:text-xl lg:text-2xl text-white leading-[150%] mb-4">
                      Black Lotus empowers our team to move faster and ship products with confidence.
                    </p>
                    <div className="flex items-center gap-3 sm:gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm sm:text-base text-white/70">{"Black Lotus"}</p>
                      </div>
                    </div>
                  </div>
                </div>
